...
class TransactionsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk and self.instance.owner_id:
            self.fields['status'].queryset = Status.objects.filter(owner=self.instance.owner)
            self.fields['operation_type'].queryset = OperationType.objects.filter(owner=self.instance.owner)
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    list_filter = ('owner', 'operation_type',)
    search_fields = ('name', 'owner__username', 'operation_type__name')
    list_select_related = ('owner', 'operation_type',)
...
class SubcategoryAdmin(admin.ModelAdmin):
    ...
    list_filter = ('category__owner', 'category__operation_type', 'category',)
    search_fields = ('name', 'category__name', 'category__owner__username')
    list_select_related = ('category', 'category__owner', 'category__operation_type',)
